...
const config: DocsThemeConfig = {
  logo: <span>hi </span>,
  project: {
    link: 'https://github.com/modi',
  },
  chat: {
    link: 'https://api.whatsapp.com/send/?phone=918849531011&text&type=phone_number&app_absent=0',
  ...
  footer: {
    text: `MIT ${new Date().getFullYear()} © hi Inc.`,
  },
